...
resolve, the complete permutation invariant is exact and symmetric, generated
root provenance is intact, no duplicate ids, no reconstructed forms,
Masoretic pointing present, every original-script string inside its own
Unicode block, script mappers correct).
